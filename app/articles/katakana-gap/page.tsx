    ...
    <div style={{ maxWidth: "720px", margin: "0 auto" }}>
      ...
      >
        ...
        <p>
          ...
          高低を表す表現に特化して使われる。
          英語話者に"My tension is high today"と言っても
          「今日は張り切っている」とは受け取られない。
        </p>

        <p>
          一方「クレーム（claim）」は日本語で「苦情・抗議」を意味するが、
          英語の"claim"はより広く「要求・主張・権利の申し立て」全般を指す。
          保険の「保険金請求（insurance claim）」も、土地の「権利主張
          （land claim）」も、単なる「申し立て（claim）」だ。
        ...
        >
          ...
          >
            ...
            <li>
              Peter Trudgill, <em>Sociolinguistics: An Introduction to Language
              and Society</em>, Penguin Books
            </li>
          </ul>
        </div>
