...
export const metadata = {
  ...
  description: "「デジタルトランスフォーメーション」——この言葉を明治の翻訳家が訳したなら、どんな語を生み出しただろうか。翻訳語の視点からDXを解剖する試み。",
  alternates: { canonical: "https://shaqai.reload.co.jp/articles/dx-translation/" },
  openGraph: {
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: ".625rem" }}>
            <div>
              <p style={{ fontSize: ".875rem", color: "#e2dcd0", marginBottom: ".2rem" }}>Digital（デジタル）</p>
              <p style={{ fontSize: ".8125rem", color: "#908a7a", lineHeight: 1.7 }}>
                情報をデジタル信号（0と1）で扱う技術・手法の総称。
                コンピュータ・ソフトウェア・ネットワーク・AIなどを含む広義の概念。
              </p>
            </div>
            <div>
              <p style={{ fontSize: ".875rem", color: "#e2dcd0", marginBottom: ".2rem" }}>Transformation（トランスフォーメーション）</p>
              <p style={{ fontSize: ".8125rem", color: "#908a7a", lineHeight: 1.7 }}>
        ...
        >
          <p style={{ fontSize: ".875rem", color: "#c8a96e", marginBottom: ".75rem", fontWeight: "bold" }}>
            「Digital」の訳語候補
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: ".75rem" }}>
            <div>
              <p style={{ fontSize: ".875rem", color: "#e2dcd0", marginBottom: ".2rem" }}>数位（すうい）</p>
              <p style={{ fontSize: ".8125rem", color: "#908a7a", lineHeight: 1.7 }}>
            ...
            <div>
              <p style={{ fontSize: ".875rem", color: "#e2dcd0", marginBottom: ".2rem" }}>電算（でんさん）</p>
              <p style={{ fontSize: ".8125rem", color: "#908a7a", lineHeight: 1.7 }}>
            ...
            <div>
              <p style={{ fontSize: ".875rem", color: "#e2dcd0", marginBottom: ".2rem" }}>情報（じょうほう）</p>
              <p style={{ fontSize: ".8125rem", color: "#908a7a", lineHeight: 1.7 }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: ".75rem" }}>
            <div>
              <p style={{ fontSize: ".875rem", color: "#e2dcd0", marginBottom: ".2rem" }}>数位変革（すういへんかく）</p>
              <p style={{ fontSize: ".8125rem", color: "#908a7a", lineHeight: 1.7 }}>
            ...
            <div>
              <p style={{ fontSize: ".875rem", color: "#e2dcd0", marginBottom: ".2rem" }}>情報変容（じょうほうへんよう）</p>
              <p style={{ fontSize: ".8125rem", color: "#908a7a", lineHeight: 1.7 }}>
            ...
            <div>
              <p style={{ fontSize: ".875rem", color: "#e2dcd0", marginBottom: ".2rem" }}>電算革新（でんさんかくしん）</p>
              <p style={{ fontSize: ".8125rem", color: "#908a7a", lineHeight: 1.7 }}>
        ...
        >
          ...
          <ul style={{ paddingLeft: "1.25rem", display: "flex", flexDirection: "column", gap: ".25rem" }}>
            ...
            <li>Erik Stolterman & Anna Croon Fors, "Information Technology and the Good Life" (2004)</li>
